...
class inagro_agri_cultivation_plan_an_organic_report(models.Model):
    _name = "cultivation.plan_an_organic_report"
    _description = "Cultivation Plan An Organic Report"
    _auto = False
    ...
    date_plan_an_organic = fields.Date('Date', readonly=True)
    ...
    def _select(self):
        select_str = """
            SELECT
                ...
                cl. STATE,
                cpd. NAME AS date_plan_an_organic
        """
        return select_str
    ...
    def _from(self):
        from_str = """
            ...
            LEFT JOIN cultivation_plan_line_an_organik_date_rel cdo ON cl. ID = cdo.an_organic_date
