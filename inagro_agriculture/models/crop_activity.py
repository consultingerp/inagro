...
class inagro_crop_activity(models.Model):
    ...
    category_id = fields.Many2one('crop.category',string='Category',related="name.category_id")
    varieties_id = fields.Many2one('crop.varieties',string='Varieties',related="name.varieties_id")
    area_location_id = fields.Many2one('res.partner',string='Location Area',related="name.area_location_id")
