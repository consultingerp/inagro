...
class HotelServiceLine(models.Model):
    ...
    def on_change_checkout(self):
        ...
        if self.ser_checkin_date and self.ser_checkout_date:
            ...
            print(self.ser_checkin_date.date(),' date cek in')
            d1 = datetime.strptime(str(self.ser_checkin_date.date()), "%Y-%m-%d")
            d2 = datetime.strptime(str(self.ser_checkout_date.date()), "%Y-%m-%d")
